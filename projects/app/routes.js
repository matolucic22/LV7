...
// normal routes ===============================================================
   ...
   //get view for add project
    ...
    app.post('/profile/addproject', isLoggedIn, function(req, res) {
        var naziv_projekta = req.body.naziv;
        var opis_projekta = req.body.opis;
        var cijena_projekta = req.body.cijena;
        var obavljeni_poslovi = req.body.obavljeni;
        ...
        mongoose.model('Project').create({
            ...
            datum_pocetka : datum_pocetak,
            datum_zavrsetka: datum_zavrsetak,
